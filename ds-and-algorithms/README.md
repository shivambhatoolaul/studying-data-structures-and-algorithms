...
- A `README.md` file containing:
    - A summary of what the pattern is and when it is best used
- `.md` file(s) containing:
    - A problem with a solution that uses this pattern, and the its key takeway(s)
